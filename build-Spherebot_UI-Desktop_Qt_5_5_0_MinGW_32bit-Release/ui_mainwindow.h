...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(8, 0, 609, 191));
        ...
        layoutWidget1->setGeometry(QRect(0, 200, 539, 48));
        ...
        layoutWidget2->setGeometry(QRect(20, 20, 461, 48));
        ...
        layoutWidget5->setGeometry(QRect(20, 290, 541, 211));
        ...
        layoutWidget6->setGeometry(QRect(570, 10, 642, 491));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        resetButton->setText(QApplication::translate("MainWindow", "Reset portlist", 0));
