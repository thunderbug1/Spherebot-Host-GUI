...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_rxThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 11)
    ...
    "rxThread\0lineReceived\0\0receiveData\0"
};
...
const QMetaObject rxThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_rxThread.data,
      qt_meta_data_rxThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rxThread.stringdata))
