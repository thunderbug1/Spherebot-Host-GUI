...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        graphicsView->setGeometry(QRect(1040, 10, 441, 241));
        ...
        gcodeView = new QGraphicsView(centralWidget);
        gcodeView->setObjectName(QStringLiteral("gcodeView"));
        gcodeView->setEnabled(false);
        gcodeView->setGeometry(QRect(1040, 260, 441, 251));
